<template>
	<view :class="runtime.show ? 'captcha-root show': 'captcha-root'" :style="theme.root">
		<view class="captcha-modal">
			<view class="captcha-modal-close" @click="close"><image src="data:image/svg+xml;base64,"></image></view>
			...
			uni.request({
				...
				success: ((res) => {
					...
					if(res.statusCode == 200 && (res.data.code == 0 || res.data.errno == 0)) {
						...
						_this.$emit('success',_this.runtime.token)
